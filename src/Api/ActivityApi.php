...
class ActivityApi
{
     ...
     * @throws \Gitee\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gitee\Model\UserMessageList
     */
     ...
     * @throws \Gitee\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gitee\Model\UserMessageList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Gitee\Model\UserMessageList';
    ...
    protected function getV5NotificationsMessagesRequest($accessToken = null, $unread = null, $since = null, $before = null, $ids = null, $page = '1', $perPage = '20')
    {
        if ($perPage !== null && $perPage > 100) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5NotificationsMessages, must be smaller than or equal to 100.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5NotificationsMessages, must be bigger than or equal to 1.');
        }
     ...
     * @throws \Gitee\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Gitee\Model\UserNotificationList
     */
     ...
     * @throws \Gitee\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Gitee\Model\UserNotificationList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Gitee\Model\UserNotificationList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Gitee\Model\UserNotificationList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        if ($perPage !== null && $perPage > 100) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5NotificationsThreads, must be smaller than or equal to 100.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5NotificationsThreads, must be bigger than or equal to 1.');
        }
    ...
    protected function getV5ReposOwnerRepoNotificationsRequest($owner, $repo, $accessToken = null, $unread = null, $participating = null, $type = 'all', $since = null, $before = null, $ids = null, $page = '1', $perPage = '20')
    {
        ...
        if ($perPage !== null && $perPage > 100) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5ReposOwnerRepoNotifications, must be smaller than or equal to 100.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5ReposOwnerRepoNotifications, must be bigger than or equal to 1.');
        }
    ...
    protected function getV5ReposOwnerRepoStargazersRequest($owner, $repo, $accessToken = null, $page = '1', $perPage = '20')
    {
        ...
        if ($perPage !== null && $perPage > 100) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5ReposOwnerRepoStargazers, must be smaller than or equal to 100.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5ReposOwnerRepoStargazers, must be bigger than or equal to 1.');
        }
    ...
    protected function getV5ReposOwnerRepoSubscribersRequest($owner, $repo, $accessToken = null, $page = '1', $perPage = '20')
    {
        ...
        if ($perPage !== null && $perPage > 100) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5ReposOwnerRepoSubscribers, must be smaller than or equal to 100.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5ReposOwnerRepoSubscribers, must be bigger than or equal to 1.');
        }
    ...
    {
        if ($perPage !== null && $perPage > 100) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5UserStarred, must be smaller than or equal to 100.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5UserStarred, must be bigger than or equal to 1.');
        }
    ...
    {
        if ($perPage !== null && $perPage > 100) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5UserSubscriptions, must be smaller than or equal to 100.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ActivityApi.getV5UserSubscriptions, must be bigger than or equal to 1.');
        }
