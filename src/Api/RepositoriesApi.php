...
class RepositoriesApi
{
     ...
     * @throws \Gitee\ApiException on non-2xx response
     */
    public function getV5EnterprisesEnterpriseRepos($enterprise, $accessToken = null, $type = 'all', $direct = null, $page = '1', $perPage = '20')
    {
        list($response) = $this->getV5EnterprisesEnterpriseReposWithHttpInfo($enterprise, $accessToken, $type, $direct, $page, $perPage);
        return $response;
    }
     ...
     */
    public function getV5EnterprisesEnterpriseReposWithHttpInfo($enterprise, $accessToken = null, $type = 'all', $direct = null, $page = '1', $perPage = '20')
    {
        $returnType = '\Gitee\Model\Project';
        $request = $this->getV5EnterprisesEnterpriseReposRequest($enterprise, $accessToken, $type, $direct, $page, $perPage);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV5EnterprisesEnterpriseReposAsync($enterprise, $accessToken = null, $type = 'all', $direct = null, $page = '1', $perPage = '20')
    {
        return $this->getV5EnterprisesEnterpriseReposAsyncWithHttpInfo($enterprise, $accessToken, $type, $direct, $page, $perPage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV5EnterprisesEnterpriseReposAsyncWithHttpInfo($enterprise, $accessToken = null, $type = 'all', $direct = null, $page = '1', $perPage = '20')
    {
        $returnType = '\Gitee\Model\Project';
        $request = $this->getV5EnterprisesEnterpriseReposRequest($enterprise, $accessToken, $type, $direct, $page, $perPage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getV5EnterprisesEnterpriseReposRequest($enterprise, $accessToken = null, $type = 'all', $direct = null, $page = '1', $perPage = '20')
    {
     ...
     * @throws \Gitee\ApiException on non-2xx response
     */
    public function getV5ReposOwnerRepoBranches($owner, $repo, $accessToken = null)
    {
        list($response) = $this->getV5ReposOwnerRepoBranchesWithHttpInfo($owner, $repo, $accessToken);
        return $response;
    }
     ...
     */
    public function getV5ReposOwnerRepoBranchesWithHttpInfo($owner, $repo, $accessToken = null)
    {
        $returnType = '\Gitee\Model\Branch[]';
        $request = $this->getV5ReposOwnerRepoBranchesRequest($owner, $repo, $accessToken);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV5ReposOwnerRepoBranchesAsync($owner, $repo, $accessToken = null)
    {
        return $this->getV5ReposOwnerRepoBranchesAsyncWithHttpInfo($owner, $repo, $accessToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV5ReposOwnerRepoBranchesAsyncWithHttpInfo($owner, $repo, $accessToken = null)
    {
        $returnType = '\Gitee\Model\Branch[]';
        $request = $this->getV5ReposOwnerRepoBranchesRequest($owner, $repo, $accessToken);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getV5ReposOwnerRepoBranchesRequest($owner, $repo, $accessToken = null)
    {
        // verify the required parameter 'owner' is set
        if ($owner === null || (is_array($owner) && count($owner) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $owner 仓库所属空间地址(企业、组织或个人的地址path) (required)
     * @param  string $repo 仓库路径(path) (required)
     * @param  string $base Commit提交的SHA值或者分支名作为对比起点 (required)
     * @param  string $head Commit提交的SHA值或者分支名作为对比终点 (required)
     * @param  string $accessToken 用户授权码 (optional)
     *
     ...
     * @throws \Gitee\ApiException on non-2xx response
     */
    public function getV5ReposOwnerRepoCompareBaseHead($owner, $repo, $base, $head, $accessToken = null)
    {
        list($response) = $this->getV5ReposOwnerRepoCompareBaseHeadWithHttpInfo($owner, $repo, $base, $head, $accessToken);
        return $response;
    }
     ...
     */
    public function getV5ReposOwnerRepoCompareBaseHeadWithHttpInfo($owner, $repo, $base, $head, $accessToken = null)
    {
        $returnType = '\Gitee\Model\Compare';
        $request = $this->getV5ReposOwnerRepoCompareBaseHeadRequest($owner, $repo, $base, $head, $accessToken);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV5ReposOwnerRepoCompareBaseHeadAsync($owner, $repo, $base, $head, $accessToken = null)
    {
        return $this->getV5ReposOwnerRepoCompareBaseHeadAsyncWithHttpInfo($owner, $repo, $base, $head, $accessToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV5ReposOwnerRepoCompareBaseHeadAsyncWithHttpInfo($owner, $repo, $base, $head, $accessToken = null)
    {
        $returnType = '\Gitee\Model\Compare';
        $request = $this->getV5ReposOwnerRepoCompareBaseHeadRequest($owner, $repo, $base, $head, $accessToken);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getV5ReposOwnerRepoCompareBaseHeadRequest($owner, $repo, $base, $head, $accessToken = null)
    {
        // verify the required parameter 'owner' is set
        if ($owner === null || (is_array($owner) && count($owner) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getV5ReposOwnerRepoTags($owner, $repo, $accessToken = null)
    {
        list($response) = $this->getV5ReposOwnerRepoTagsWithHttpInfo($owner, $repo, $accessToken);
        return $response;
    }
     ...
     */
    public function getV5ReposOwnerRepoTagsWithHttpInfo($owner, $repo, $accessToken = null)
    {
        $returnType = '\Gitee\Model\Tag';
        $request = $this->getV5ReposOwnerRepoTagsRequest($owner, $repo, $accessToken);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV5ReposOwnerRepoTagsAsync($owner, $repo, $accessToken = null)
    {
        return $this->getV5ReposOwnerRepoTagsAsyncWithHttpInfo($owner, $repo, $accessToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV5ReposOwnerRepoTagsAsyncWithHttpInfo($owner, $repo, $accessToken = null)
    {
        $returnType = '\Gitee\Model\Tag';
        $request = $this->getV5ReposOwnerRepoTagsRequest($owner, $repo, $accessToken);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getV5ReposOwnerRepoTagsRequest($owner, $repo, $accessToken = null)
    {
        // verify the required parameter 'owner' is set
        if ($owner === null || (is_array($owner) && count($owner) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $repo 仓库路径(path) (required)
     * @param  string $accessToken 用户授权码 (optional)
     * @param  string $organization 组织空间地址，不填写默认Fork到用户个人空间地址 (optional)
     ...
     * @param  string $repo 仓库路径(path) (required)
     * @param  string $wildcard 分支/通配符 (required)
     * @param  string $pusher admin: 仓库管理员, none: 禁止任何人合并; 用户: 个人的地址path(多个用户用 &#39;;&#39; 隔开) (required)
     ...
     * @return \Gitee\Model\ProtectionRule
     */
    public function putV5ReposOwnerRepoBranchesSettingNew($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null)
    {
        list($response) = $this->putV5ReposOwnerRepoBranchesSettingNewWithHttpInfo($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken);
        return $response;
    }
     ...
     * @return array of \Gitee\Model\ProtectionRule, HTTP status code, HTTP response headers (array of strings)
     */
    public function putV5ReposOwnerRepoBranchesSettingNewWithHttpInfo($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null)
    {
        $returnType = '\Gitee\Model\ProtectionRule';
        $request = $this->putV5ReposOwnerRepoBranchesSettingNewRequest($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putV5ReposOwnerRepoBranchesSettingNewAsync($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null)
    {
        return $this->putV5ReposOwnerRepoBranchesSettingNewAsyncWithHttpInfo($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putV5ReposOwnerRepoBranchesSettingNewAsyncWithHttpInfo($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null)
    {
        $returnType = '\Gitee\Model\ProtectionRule';
        $request = $this->putV5ReposOwnerRepoBranchesSettingNewRequest($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putV5ReposOwnerRepoBranchesSettingNewRequest($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null)
    {
        // verify the required parameter 'owner' is set
        if ($owner === null || (is_array($owner) && count($owner) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Gitee\Model\ProtectionRule
     */
    public function putV5ReposOwnerRepoBranchesWildcardSetting($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null, $newWildcard = null)
    {
        list($response) = $this->putV5ReposOwnerRepoBranchesWildcardSettingWithHttpInfo($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken, $newWildcard);
        return $response;
    }
     ...
     * @return array of \Gitee\Model\ProtectionRule, HTTP status code, HTTP response headers (array of strings)
     */
    public function putV5ReposOwnerRepoBranchesWildcardSettingWithHttpInfo($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null, $newWildcard = null)
    {
        $returnType = '\Gitee\Model\ProtectionRule';
        $request = $this->putV5ReposOwnerRepoBranchesWildcardSettingRequest($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken, $newWildcard);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putV5ReposOwnerRepoBranchesWildcardSettingAsync($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null, $newWildcard = null)
    {
        return $this->putV5ReposOwnerRepoBranchesWildcardSettingAsyncWithHttpInfo($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken, $newWildcard)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putV5ReposOwnerRepoBranchesWildcardSettingAsyncWithHttpInfo($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null, $newWildcard = null)
    {
        $returnType = '\Gitee\Model\ProtectionRule';
        $request = $this->putV5ReposOwnerRepoBranchesWildcardSettingRequest($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken, $newWildcard);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putV5ReposOwnerRepoBranchesWildcardSettingRequest($owner, $repo, $wildcard, $pusher, $merger, $mode, $accessToken = null, $newWildcard = null)
    {
        // verify the required parameter 'owner' is set
        if ($owner === null || (is_array($owner) && count($owner) === 0)) {
            throw new \InvalidArgumentException(
