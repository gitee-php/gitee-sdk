...
class WebhooksApi
{
    ...
    protected function getV5ReposOwnerRepoHooksRequest($owner, $repo, $accessToken = null, $page = '1', $perPage = '20')
    {
        ...
        if ($perPage !== null && $perPage > 100) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling WebhooksApi.getV5ReposOwnerRepoHooks, must be smaller than or equal to 100.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling WebhooksApi.getV5ReposOwnerRepoHooks, must be bigger than or equal to 1.');
        }
